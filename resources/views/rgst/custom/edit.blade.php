...
<div class="bl_rgstForm_wrapper">
  <div class="bl_rgstForm">
    <form action="{{ action('CustomController@edit')}}" method="post">
      {{ csrf_field() }}
      ...
      <div class="bl_btnUnit">
        <input class="el_btn" name="submit" type="submit" value="送信"><a class="el_btn" href="{{ action('CustomController@index')}}">キャンセル</a>
      </div>
      <!-- /.bl_btnUnit -->
    </form>
  </div>
