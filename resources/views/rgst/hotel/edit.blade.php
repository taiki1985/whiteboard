...
<div class="bl_rgstForm_wrapper">
  <div class="bl_rgstForm">
    <form action="{{ action('HotelController@edit')}}" method="post">
      {{ csrf_field() }}
      ...
      @endif
      <label for="address">住所</label><textarea class="address" name="address">{{ $form->address }}</textarea>
      @if ($errors->has('address'))
      <div class="bl_rgstForm_err">{{ $errors->first('address') }}</div>
      @endif
      <label for="address_eng">住所(英語)</label><textarea class="address_eng" name="address_eng">{{ $form->address_eng }}</textarea>
      @if ($errors->has('address_eng'))
      <div class="bl_rgstForm_err">{{ $errors->first('address_eng') }}</div>
      @endif
      ...
      @endif
      <label for="web">WEB</label><input class="web" name="web" type="text" value="{{ $form->web }}">
      @if ($errors->has('web'))
      <div class="bl_rgstForm_err">{{ $errors->first('web') }}</div>
      @endif
      <label for="check_in">チェックイン</label><input class="check_in" name="check_in" type="time" value="{{ $form->check_in }}">
      @if ($errors->has('check_in'))
      <div class="bl_rgstForm_err">{{ $errors->first('check_in') }}</div>
      @endif
      <label for="check_out">チェックアウト</label><input class="check_out" name="check_out" type="time" value="{{ $form->check_out }}">
      @if ($errors->has('check_out'))
      <div class="bl_rgstForm_err">{{ $errors->first('check_out') }}</div>
      @endif
